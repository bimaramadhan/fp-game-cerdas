...
{
    public float m_StartingHealth = 100f;               // The amount of health each Ship starts with.
    public Slider m_Slider;                             // The slider to represent how much health the Ship currently has.
    ...
    {
        // When the Ship is enabled, reset the Ship's health and whether or not it's dead.
