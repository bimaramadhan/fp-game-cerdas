...
public class ShipShooting : MonoBehaviour
{
    ...
    private void Update ()
    {
        if (Input.GetButtonDown (m_AltFireButton))
        {
            ...
            {
                m_ShootDirection = 1;
                m_AimSliderLeft.gameObject.SetActive(false);
                m_AimSliderRight.gameObject.SetActive(true);
            }
            else if (m_ShootDirection == 1)
            {
                m_ShootDirection = 0;
                m_AimSliderLeft.gameObject.SetActive(true);
                m_AimSliderRight.gameObject.SetActive(false);
            }
